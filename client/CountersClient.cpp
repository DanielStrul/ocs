...
namespace CountersClient
{
	...
	CountersClient::CountersClient(const Configuration& configuration, boost::asio::io_context& io_context)
	 ...
	 , receiver_endpoint_()
	{
		...
		receiver_endpoint_ = *resolver.resolve(udp::v6(), configuration_.hostname, configuration_.service).begin();
